            ...
            <div class="py-8 sm:py-20 border-b border-gray-300">
                <header class="text-center mb-8">
                    ...
                    <p class="text-gray-700 leading-normal text-sm sm:text-base">
                        <span v-if="post.author">autor: <g-link :to="`${post.author.path}/`" class="text-gray-700 border-b border-transparent hover:border-gray-400 transition-border-color" v-if="post.author">{{ post.author.title }}</g-link></span>
