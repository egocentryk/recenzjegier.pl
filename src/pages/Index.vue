            ...
            <header>
                <div class="max-w-xl md:max-w-3xl xl:max-w-4xl mx-auto text-center px-6 py-10 md:py-32 border-b border-gray-300">
                    <h1 class="text-4xl sm:text-5xl md:text-6xl font-sans font-bold mb-1">
                        <g-link to="/" class="text-black">Recenzje Gier</g-link>
                    </h1>
                    <p class="text-gray-700 text-lg sm:text-1xl">Zostańcie Państwo z nami...</p>
                </div>
            </header>
            <section>
...
<script>
    ...
    export default {
        ...
        metaInfo () {
            return {
                ...
                meta: [
                    ...
                    { name: "twitter:creator", content: "@egocentryj" },
        ...
        computed: {
            ...
            ogImageUrl () {
                return `${this.config.siteUrl}/images/default.png`
            }
        },
    }
</script>
